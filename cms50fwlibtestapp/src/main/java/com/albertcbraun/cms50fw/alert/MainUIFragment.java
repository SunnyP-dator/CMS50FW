...
public class MainUIFragment extends Fragment {
    ...
    private Button chartButton = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        chartButton = (Button) rootView.findViewById(R.id.chart_button);
        ...
        logButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent inte = new Intent(rootView.getContext(),LogActivity.class);
                startActivity(inte);
            }
        });
        ...
        chartButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(rootView.getContext(),RadarChartActivitry.class);
    ...
    void updateUI(long time, final String spo2, final String pulse) {
        ...
        spo2Window.setText(spo2 + PERCENT_SIGN_STRING);
        ...
        if (getView() != null) {
            ...
            db.addContact(new Contact(Integer.parseInt(spo2)));
    ...
    public void processDataFrame(DataFrame dataFrame) {
        if (dataFrame == null) {
            ...
            if (dataFrame.spo2Percentage <= ONE_HUNDRED) { // valid data frame
                ...
                updateUI(dataFrame.time, String.valueOf(dataFrame.spo2Percentage), dataFrame.pulseRate + BPM_STRING);
